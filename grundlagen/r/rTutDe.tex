...
\begin{lstlisting}[basicstyle=\fontsize{7.9pt}{8.5pt}\selectfont\ttfamily]
i <- 1:14
f <- \(i, x) sum(mean(atan(tan(sin(cos(i+x))))))
library(parallel)
...
\begin{lstlisting}[basicstyle=\fontsize{8.4pt}{8.7pt}\selectfont\ttfamily]
i <- 1:14
f <- \(i, x) sum(mean(atan(tan(sin(cos(i+x))))))
library(parallel)
...
\begin{lstlisting}[basicstyle=\fontsize{7.9pt}{8.4pt}\selectfont\ttfamily]
library(ast2ast)
...
\begin{lstlisting}[basicstyle=\fontsize{8.8pt}{9.pt}\selectfont\ttfamily]
library(nCompiler)
...
\begin{lstlisting}[basicstyle=\fontsize{7.9pt}{8.2pt}\selectfont\ttfamily]
Rcpp::cppFunction(r"(
double fc(int n) {
  double res = 0.;
