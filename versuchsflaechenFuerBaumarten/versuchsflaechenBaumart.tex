  ...
  \begin{scope}[blend mode=difference]
    ...
    \foreach \i in {0,...,5}{%
      \begin{scope}
        \node[hexa,fill=#3] (q) at ($ (p) + ({\i*60}:.85) $) {};
        \fill[white] (q) circle (1pt);
        \node[hexa,fill=#3] (q) at ($ (p) + ({\i*60}:1.7) $) {};
        \fill[white] (q) circle (1pt);
        \node[hexa,fill=#3,rotate=0] (q) at ($ (p) + ({\i*60-30}:1.7-.85/4) $) {};
        \fill[white] (q) circle (1pt);
      \end{scope}
    }
  \end{scope}
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[hexa/.style= {shape=regular polygon,regular polygon sides=6,draw,inner sep=8,rotate=30,rounded corners=4}]
    \foreach \j in {1,...,3}{%
      \foreach \i in {0,...,9}{%
        \begin{scope}
          \node[hexa,rounded corners=\i*6/9] (p) at ({(\i-Mod(\j/2,1))*sin(60)},{\j*0.75}) {};
          \fill (p) circle (1pt);
        \end{scope}
      }
    }
...
\begin{figure}[htbp]
  \centering
  \begin{tikzpicture}[hexa/.style= {shape=regular polygon,regular polygon sides=4,draw,inner sep=8,rotate=0,rounded corners=8}]
    \foreach \j in {1,...,3}{%
      \foreach \i in {0,...,9}{%
        \begin{scope}
          \node[hexa,rounded corners=\i*11/9] (p) at ({\i*0.85},{\j*0.85}) {};
          \fill (p) circle (1pt);
        \end{scope}
      }
    }
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[hexa/.style= {shape=regular polygon,regular polygon sides=6,draw,inner sep=8,rotate=30,rounded corners=4}]
    \foreach \i in {0,...,9}{%
      \hexA{\i*0.85}{0}{white}
      \hexA{\i*0.85+0.425}{.75}{black}
      \hexA{\i*0.85}{2*.75}{lightgray}
    }
  \end{tikzpicture}\\
...
\begin{figure}[htbp]
  \centering
  \begin{tikzpicture}[hexa/.style= {shape=regular polygon,regular polygon sides=4,draw,inner sep=8,rotate=0,rounded corners=10}]
    \foreach \j in {1,...,3}{%
      \foreach \i in {1,...,3}{%
        \begin{scope}
          \node[hexa] (p) at ({\i*0.85},{\j*0.85}) {};
          \fill (p) circle (1pt);
        \end{scope}
      }
      \foreach \i in {4,...,6}{%
      \begin{scope}
        \node[hexa,fill=black] (p) at ({\i*0.85},{\j*0.85}) {};
        \fill[white] (p) circle (1pt);
      \end{scope}
      }
      \foreach \i in {7,...,9}{%
      \begin{scope}
        \node[hexa,fill=lightgray] (p) at ({\i*0.85},{\j*0.85}) {};
        \fill (p) circle (1pt);
      \end{scope}
      }
    }
...
\begin{tikzpicture}[hexa/.style= {shape=regular polygon,regular polygon sides=6,draw,inner sep=8,rotate=30,rounded corners=4}]
  ...
  \foreach \i in {0,...,5}{%
    \begin{scope}
      \node[hexa] (p) at ({\i*60}:.85) {};
      \fill (p) circle (1pt);
      \node[hexa] (p) at ({\i*60}:1.7) {};
      \fill (p) circle (1pt);
      \node[hexa,rotate=0] (p) at ({\i*60-30}:1.7-.85/4) {};
      \fill (p) circle (1pt);
    \end{scope}
  }
\end{tikzpicture}
\caption{Verschiedene Hexagonal--Kleingruppen}
...
\begin{tikzpicture}[hexa/.style= {shape=regular polygon,regular polygon sides=6,draw,inner sep=8,rotate=30,rounded corners=4}]
  \hexE{0}{0}{lime}
  \hexE{-4 * .86}{2*.75}{red}
  \hexE{-3.5 * .86}{-3*.75}{white}
  \hexE{.5 * .86}{-5*.75}{lightgray}
  \hexE{4 * .86}{-2*.75}{black}
  \hexE{3.5 * .86}{3*.75}{orange}
  \hexE{-.5 * .86}{5*.75}{blue}
\end{tikzpicture}}
