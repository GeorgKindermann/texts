...
\emph{Kreisfläche}\index{Kreisfläche} (Querschnittsfläche des Stammes, die
...
an Jahrring von innen (\emph{Mark}\index{Mark}: Zentrum der Stammscheibe um den
sich die Jahrringe anlegen) nach außen (\emph{Kambium}\index{Kambium}:
