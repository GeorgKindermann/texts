...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    \begin{abstract}
      ...
      Niedrigere Stammzahlen bei Aufforstungen, Stammzahlreduktionen bei
      Naturverjüngung sowie Durchforstungen führen zu einer geringen bzw.\
      verringerten \emph{Bestandesdichte}. Mit geringer Bestandesdichte nimmt
      der Durchmesserzuwachs und die Jahrringbreite zu, nimmt der Höhenzuwachs
      bei vielen Laubbäumen ab (bei Nadelbäumen bleibt er annähernd gleich),
      nimmt die Aststärke zu, nimmt die Kronenlänge zu und die Astfreie
      Schaftlänge ab, nimmer der Kronendurchmesser zu, verlagert sich der
      Durchmesserzuwachs verstärkt am Stammfuß an, womit sich die Stammform von
      \glqq Walzenförmig\grqq{} in Richtung Kegelförmig verändert, erfolgt die
      Samen-- bzw.\ Fruchtbildung bei geringerem Alter, stellt sich eher
      Verjüngung oder (verdämmende) Bodenvegetation ein. Der flächenbezogene
      Volumszuwachs eines Bestandes bleibt über weite Bereiche der
      Bestandesdichte nahezu gleich. Solange sich die Kronen innerhalb eines
      Jahrzehnts annähernd schließen, ist mit keinen nennenswerten
      Zuwachseinbußen zu rechnen. Damit kann bei gutwüchsigen, jungen Beständen
      die Absenkung stärker (sogar um 50\,\%) erfolgen als bei
      schlechtwüchsigen, alten Beständen. Die Wuchsreaktion bei Verringerung der
      ...
      reduzieren Durchforstungen diese \emph{Risiken}. Selbst wenn keine aktive
      Baumentnahme durchgeführt wird, nimmt die Stammzahl, aufgrund von
      Mortalität durch Konkurrenz, laufend ab. Mit Durchforstungen kann man den
      Zuwachs auf qualitativ besser Bäume und bei Mischbeständen deren
      Mischungsverhältniss steuern.

      Der einzelne Baum nimmt, solange er lebt und keine Stammfäule oder andere
      Schädigungen erfährt, ständig an Holzvolumen zu. Auch Wälder können mit
      zunehmendem Alter ihren Vorrat laufend aufbauen, bis sie die Zerfallsphase
      erreichen und an Vorrat verlieren. Der laufende (jährliche) Volumszuwachs
      nimmt sowohl beim Einzelbaum als auch auf Bestandesebene zunächst mit dem
      Alter zu, bis ein Alter erreicht wird, ab dem er wieder abnimmt. Der
      durchschnittliche Zuwachs ist die Summe aller laufende Zuwächse dividiert
      durch das Alter. Der \emph{höchste durchschnittliche Zuwachs} wird in
      Mitteleuropa in der Regel zwischen dem Alter von 60 und 150~Jahren und
      stets später als der höchste laufende Zuwachs erreicht. Dieser Zeitpunkt
      wird auf gutwüchsigen Standorten und von Pionierbaumarten früher erreicht.
      Endnutzungen vor oder nach diesem Alter führen zu Zuwachsverlusten. Dieser
      Zuwachsverlust ist, solange der Erntezeitpunkt in etwa zwischen 20\,\% vor
      und 35\,\% nach dem \emph{zuwachsoptimalen Erntealter} liegt, sehr gering.
      \emph{Schadereignisse} können zu einer deutlichen Unterschreitung der
...
Dabei werden Jahrring an Jahrring von innen (\emph{Mark}\index{Mark}: Zentrum
der Stammscheibe um den sich die Jahrringe anlegen) nach außen
(\emph{Kambium}\index{Kambium}: Wachsstumsschicht zwischen Holz und Rinde) und
...
\emph{Reaktionsholz}\index{Reaktionsholz}. Nadelbäume vermehren den Zuwachs wo
vermehrt Druckbelastung $\rightarrow$
\emph{Druckholz}\index{Druckholz|see{Reaktionsholz}}, Laubbäume dort wo
Zugbelastung $\rightarrow$ \emph{Zugholz}\index{Zugholz|see{Reaktionsholz}}
...
\emph{Mykorrhiza}\index{Mykorrhiza}--Pilzen umgeben, welche die
