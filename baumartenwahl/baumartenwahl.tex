...
der Zukunft weitere Möglichkeiten zu erschließen, können auf kleinen Flächen
durchaus auch neue Baumarten erprobt werden. Dabei muss das Risiko des
Versagens der Baumart bewusst in Kauf genommen werden und deren Ausmaß auf
Kleinflächen beschränkt bleiben. 

Solange es im Versuchswesen darum geht, bloß die grundsätzliche Anbaufähigkeit einer 
Baumart in einer neuen Region zu prüfen, mag eine isolierte Betrachtung genügen. Wenn 
jedoch die Baumart mit der besten Wuchsleistung gesucht wird, müssen alle vielversprechenden 
Baumarten, sowohl heimische als auch fremdländische, zeitgleich gepflanzt und unmittelbar 
miteinander verglichen werden. Einen solchen methodischen Ansatz für Vergleichsanbauten 
forderte bereits \citet[S.~300]{reaumur1721ertragstafel}: 

\enquote{Man sollte zunächst nur sehr kleine Flächen roden und sie mit verschiedenen 
Baumarten bepflanzen, um herauszufinden, welche dort am besten gedeihen.}\footnote{\enquote{Il 
ne faudroit commencer qu’à défricher de très-petits cantons, \& à les planter de différentes 
sortes d'Arbres, pour voir ceux qui y réussiraient mieux.}} 

Bezüglich der Standortgerechtigkeit führte er weiter aus: 
\enquote{Schließlich sollte man versuchen, die Böden zu erkennen, die am besten für jede 
Baumart geeignet sind, und ihnen nur die Baumarten geben, die zu ihnen passen.}\footnote{\enquote{Enfin 
il faudroit tâcher de reconnoître les terrains les plus propres à chaque espéce d’Arbres, 
\& ne leur donner que Les espéces d’Arbres qui leur sont propres.}} 

Auch den Einbezug nicht-heimischer Arten sprach er direkt an: 
\enquote{Sollte unsere Aufmerksamkeit sich nicht sogar darauf richten, zu prüfen, ob es nicht 
Bäume aus fremden Ländern gibt, die für uns nützlich wären und die leicht im Königreich 
gedeihen würden?}\footnote{\enquote{Notre attention ne devroit-elle pas aller jusques à 
chercher si les pays étrangers n'ont point des Arbres qui nous seroient utiles, qui 
croîtroient aisément dans le Royaume?}}

Flächen, auf denen verschiedene Baumarten
...
\cite{mayer1970anbauversuch} gemacht.

Von der bayerischen Landesanstalt für Wald
...
Leitung von Christoph Jasser eine Fläche mit 44~Baumarten angelegt.
...
verschiedensten Baumarten aufgeforstet.\footnote{Diese Flächen stellen einen bislang weitgehend ungehobenen Datenschatz dar. Nachstehend sind Informationen zur Lage einiger dieser Flächen dokumentiert, um eine solche Auswertung zu erleichtern:
\emph{2025:} 21. Bezirk -- Josef-Flandorfer-Straße 90-96 / Orasteig
\emph{2024:} 22. Bezirk -- Park der Artenvielfalt, Stadlbreiten (gegenüber Nr. 3)
\emph{2023:} 22. Bezirk -- Johann-Kutschera-Gasse/Ecke Anna-Müller-Straße
...
fortgesetzt, sondern auch verstärkt wird, um das Möglichkeitsspektrum bei der
...
beispielsweise diese Bestände mit wirtschaftlich unvertretbarem Aufwand
bewässert werden würden und somit das Aufkommen von Baumarten ermöglicht wird,
die in der Praxis versagen werden, wäre damit der Praxis nicht geholfen.
...
\citep[S.~86]{hegi1906IllustrierteFloraBd1} auf, die drei verschiedene
Fichtenherkünfte mit verschiedenen Wuchsformen und Wuchsleistungen zeigt. Da
die Publikation aus dem Jahr \citeyear{hegi1906IllustrierteFloraBd1} stammt, wurden
...
potenziell natürlichen Waldgesellschaft bzw.\ allen Sukzessionsstadien bis zu
...
(Grasland, Acker) geeigneter werden kann. In vielen Fällen zeigt sich die
...
insbesondere wenn nur ein Jahr betrachtet wurde, noch keinen ausreichenden Hinweis
...
kommt, werden die Bedingungen von Standorten, die den erwarteten Endzustand
...
konkurrenzstärkeren Nachbarn einer anderen Baumart, um die
konkurrenzschwächere Baumart zu erhalten) über den Pflegeaufwand. Allgemein
...
beteiligten Baum-- und Pflanzenarten abhängen.
...
Straucharten, wie etwa Robinie, Erle, Geweihbaum, Gleditschie,
Gelbholz, Schnurbaum, Goldregen, Sanddorn, Ölweide, Blasenstrauch,
Ginster oder anderen, zum Teil nicht verholzenden Leguminosen die
...
Schläge, die sich z.\,B.\ entgegen der Hauptwindrichtung im Laufe der
Zeit aneinanderreihen) vorgeschlagen. Aber nicht nur der unmittelbare
...
Standort. Ein wesentlicher, oft limitierender Risikofaktor ist zudem
der lokale Wilddruck (Verbiss, Fegen, Schälen), welcher die Etablierung
bestimmter Baumarten ohne kostenintensive Schutzmaßnahmen gänzlich
verhindern kann. Angesichts fortschreitender Standortsveränderungen
verschiebt sich der Fokus bei der Baumartenwahl zunehmend: Es wird weniger
nach derjenigen Baumart gesucht, die unter theoretischen Idealbedingungen
maximal oder optimal wächst. Vielmehr gewinnt eine risikominimierende
Strategie an Bedeutung, bei der Baumarten gewählt werden, die verlässlich
gut wachsen, deren Holz eine klare Verwendung sowie einen soliden Marktwert
besitzt und die gleichzeitig eine möglichst geringe Ausfallwahrscheinlichkeit
aufweisen. Bestandesdichte und geplante Umtriebszeit stellen weitere
...
kürzeren Umtriebszeit, die Ungewissheit ein wenig einzuschränken, da
...
geringer ist. Gleichzeitig beeinflusst die Umtriebszeit auch die
...
Die Baumartenwahl ist für \emph{Reinbestände} einfacher als für
\emph{Mischbestände}. Wobei Reinbestände keinesfalls bedeuten, dass eine ganze
...
zufällig, geklumpt) und ob ein Bestand gleich-- oder ungleichaltrig
sein soll, beeinflussen ebenfalls die Baumartenwahl. In mehrschichtigen
...
einer Kombination von beiden beeinflusst die zur Auswahl stehenden
Baumarten.

\subsection{Schutzwirkung}
\label{ssec:schutz}

Baumarten unterscheiden sich hinsichtlich des Rückhaltevermögens von
...
Gleichmäßigkeit der Wasserspende in Quellschutzwäldern hat. In
Quellschutzwäldern spielen auch die Nichtfreisetzung von Stickstoff und
eine möglichst geringe Deposition von Luftschadstoffen eine Rolle.
Verschiedene Baumarten unterscheiden sich hinsichtlich ihrer
...
Für die Baumartenwahl sind die waldbaulichen Eigenschaften und
...
Hinweise auf invasive Arten, die sich selbstständig relativ leicht verbreiten und
...
die Bereitschaft, in Verjüngungsmaßnahmen zu investieren, eingeschränkt ist, die
...
dem möglichen Nutzen ist schwierig. Ragweed verursacht Kosten und belastet viele
...
kann. Dass die Standortsverhältnisse außerhalb dieses Gebiets eine weitere
...
zukünftige Baumartenverbreitungen bei angenommenen Klimaszenarien gezeichnet.
...
eminent wichtig. So mag auf einem Standort beispielsweise die Flaumeiche
...
angetroffen werden, die ihnen am besten zusagen würden, sondern auf jenen, wo sie
...
Gegebenheiten geprägten Bestandesbonität beträchtlich abweichen können. Diese
...
Neben diesen waldspezifischen Karten geben auch Karten zu Geologie,
...
wird zwischen der physiologischen Amplitude, dem physiologischen Optimum
und dem Herrschaftsbereich der Baumart in der Regel für eine bestimmte
...
\end{tikzpicture}
  ...
  \footnotesize{
    ...
    \tikz \fill[gray!160,rounded corners=2] (0,0) rectangle (1em,1em);~Herrschaftsbereich der Baumart (ökologisches Optimum / Nische)
  }
  \label{fig:oekogramm}
\end{figure}

Ähnlich den Ökogrammen sind \emph{Klimadiagramme} mit den Achsen
Temperatur und Niederschlag, in welchen, meist als Punktwolke,
...
Stickstoff, Salz und Schwermetallresistenz. Weiters werden die Lebensform und die
...
Eine unterschiedliche Trockentoleranz zweier Baumarten kann man in trockenen Jahren relativ einfach beobachten (Abb.~\ref{fig:eicheRobinie}).

\begin{figure}[htbp]
  \centering
  \includegraphics[width=.95\columnwidth]{./pic/eicheRobinie.jpg}
  \caption{Unterschiedliche Reaktion von Stieleiche (braune Blätter) und Robinie (grüne Belaubung darunter) auf Trockenstress. 4 August 2026 beim Fuchshäufel in der Lobau, Wien.}
  \label{fig:eicheRobinie}
\end{figure}

\subsection{Gefährdungen}
\label{sec:gefaerdungen}

Die Disposition für bestimmte Gefahren hängt von vielen
...
Tabelle~\ref{tab:gefaehrdungen} von Wellenstein in
...
\begin{table*}[htbp!]
  ...
  \caption{Ansprüche und Eigenschaften heimischer Wirtschaftsbaumarten nach \citet[Bd.~1, S.~183\,f.]{bauer1962WaldbauAlsWissenschaft}}
...
\begin{table*}[htbp!]
  ...
  \caption{Natürlicher Gesellschaftsanschluss mit Vergesellschaftung der Baumarten in Wäldern des Ostalpenraumes \citep{mayer1992Waldbau}}
  \footnotesize{\hst{0}\dots Auwald,
    \hst{1}\dots Planar--Kollin --400\,m,
...
\afterpage{%
  ...
  \begin{landscape}
    ...
    \footnotesize{
      ...
      X\dots Nische: \ratingC{0}{0}\dots Pionier, \ratingC{0}{50}\dots Extremstandort, \ratingC{0}{100}\dots Konkurrenzstark\\
      ...
      K\dots Kontinentalität: \ratingC{0}{0}\dots Verträgt nur geringe Temperaturschwankungen (ozeanisch), \ratingC{0}{100}\dots Verträgt große Temperaturschwankungen (kontinental)\\
      ...
      G\dots Als Nahrung verwendet / Giftig: \jaNeinP{0}{1}\dots Als Nahrung verwendet. Dies bedeutet \textbf{nicht}, dass diese Pflanze ohne Gefahr essbar ist.
      \jaNeinP{1}{0}\dots Giftig. Ungiftig wurde hier nicht vergeben! D.\,h.\ keine Angabe bedeutet \textbf{nicht}, dass diese Pflanze ohne Gefahr essbar ist.\\
      ...
      d\dots Holzdichte: \ratingC{0}{0}\dots Darrgewicht 350 kg/m$^3$ oder weniger, \ratingC{0}{100}\dots Darrgewicht 800 kg/m$^3$ oder mehr\\
      x\dots Dauerhaftigkeit des unbehandelten Kernholzes in Anlehnung an EN 350-2: \ratingC{0}{0}\dots geringe Dauerhaftigkeit, \ratingC{0}{100}\dots Sehr dauerhaft\\
