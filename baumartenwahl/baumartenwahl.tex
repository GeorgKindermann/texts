...
Baumarten, kommt. Wenn der Aufwand des Baumartenwechsels, jenem des
bisherige Baumart beibehalten, gleich ist oder gar unterschreitet und
andere Kriterien ebenfalls nicht dagegen sprechen, stellt er eine
...
Eine erster Entwurf einer längeren Baumartenliste samt ein paar
Charakteristika ist in Tabelle~\ref{tab:BaumartenCharakteristik}. Dazu
werden gerne Hinweise zu Ergänzungen und Korrekturen in diese Liste
eingearbeitet. Es ist zu beachten, dass derzeit nicht alle dort
aufgelisteten Baumarten nach dem Forstgesetz als Baumart betrachtet
werden und somit rechtlich keinen Wald bilden können. Verboten sind
diese Baumarten jedoch nicht. Ihr Anteil darf, solange keine
Sondergenehmigung vorliegt, jedoch nicht so hoch sein, dass der
verbleibende Bestand nicht mehr in der Lage ist nach dem Forstgesetz
einen Wald zu bilden. Umgekehrt werden solche Baumarten,
beispielsweise bei einer Ackeraufforstung, die Ladnnutzungsform von
Landwirtschaft auf Wald rechtlich nicht vollziehen. Verbotene Baum--
und Straucharten gibt es laut österreichischem Forstgesetz zur Zeit
nicht. Von den restlichen Pflanzen ist mit derzeit nur das
burgenländische Ragweed--Bekämpfungsgesetz bekannt in dem
Grundeigentümer verpflichtet werden Ragweed zu entfernen. Dennoch gibt
es auch bei Baumarten hinweise auf invasive Arten die sich selbständig
relativ leicht verbreiten und teilweise in der Lage sind den Standort
zu verändern und damit die derzeit dort vorhandene Vegetation zu
verdrängen. Umgekehrt ist aber gerade in Regionen, in denen die
Verjüngung schwierig ist und aufgrund einer geringen Wuchsleistung die
Bereitschaft in Verjüngungsmaßnahmen zu investiert eingeschränkt ist,
die Eigenschaft einer natürlichen Verjüngung sowie die Fähigkeit zur
Steigerung der Wuchsleistung durch Stickstofffixierung oft willkommen.
...
\tablehead{Code & Art Sci & Kurz & Art & H & A & X & D & T & K & W & L & R & N & F & S & M & B & Ü & G\\ \hline \noalign{\vskip .1em}}
\tabletail{\hline Code & Art Sci & Kurz & Art & H & A & X & D & T & K & W & L & R & N & F & S & M & B & Ü & G\\}
\tablelasttail{Code & Art Sci & Kurz & Art & H & A & X & D & T & K & W & L & R & N & F & S & M & B & Ü & G\\}

\afterpage{%
  \onecolumn
  \begin{landscape}
    \begin{xtabular}{llllcccc@{\enspace}cccc@{\enspace}ccccc@{\enspace}ccc}
    ...
    A\dots Alter das erreicht werden kann: \ratingC{0}{25}\dots 100~Jahre, \ratingC{0}{50}\dots 200~Jahre, \ratingC{0}{75}\dots 300~Jahre, \ratingC{0}{100}\dots 400~Jahre oder mehr\\
    ...
    F\dots Stickstofffixierung: \jaNein{0}\dots Nein, \jaNein{1}\dots Ja\\
    S\dots Salzresist: \jaNein{0}\dots Nein, \jaNein{1}\dots Ja\\
    M\dots Schwermetallresist: \jaNein{0}\dots Nein, \jaNein{1}\dots Ja\\
    B\dots Windbestäubt: \jaNein{0}\dots Nein, \jaNein{1}\dots Ja\\
    ...
    G\dots Giftig: \jaNein{1}\dots Ja\\
    }
  \end{landscape}
  \twocolumn
}
