...
schwierigen Standortverhältnissen zurechtkommen, kann deren
...
steigert damit auf einigen Standorten sowohl die Zuwachsleistung
...
\summary{Die Robinie gilt als trockenheitstolerante Baumart, die sich
  ...
  Umtriebszeiten verwendet werden. Ökologisch muss sie differenziert
...
Unter den heimischen bestandsbildenden Hauptbaumarten kommen meist
...
Die Fähigkeit, Wurzelbrut bilden zu können, ist aber auch ein Grund,
...
Heide, die 1940 als Naturdenkmal eingezäunt und seitdem so gut wie
...
\begin{figure*}[htbp]
  ...
  \bicaption{Robinie (Bildmitte), zusammen mit eingriffeliger Weißdorn (links), Zerreiche (rechts) und Feld-Mannstreu (Hintergrund) auf einem trocken erscheinenden Standort. Die Robinie hat ihre Fiederblättchen nach oben geklappt. Rechts: Robinienpflock im Nationalpark Donau-Auen, unweit des Standorts vom linken Bild.}{Robinia (center), together with common hawthorn (left), Turkey oak (right), and field eryngo (background) at an apparently dry site. The robinia has folded its leaflets upward. Right: Robinia stake in the Donau-Auen National Park, not far from the location shown in the left image.}
...
werden. Zudem können Ausnahmen für Einrichtungen, die Forschung
durchführen oder Ex-situ-Erhaltung betreiben, genehmigt werden.
In Ausnahmefällen
...
Sollte sich die rechtliche Situation ändern oder aus anderen Gründen
...
In \citet{langmaier2020alienPlants} heißt es:
...
\citet{kraftova2017robinieVoegel} zeigten, dass bei einem mittleren
...
\begin{figure}[htbp]
  ...
  \bicaption{Zuwachssteigerung eines Trompetenbaumbestandes neben einem Robinenbestandesrand nach \citet{ferguson1922robinie,chapman1935robinie}.}{Increase in growth of a trumpet tree stand at the edge of a Robinia stand according to \citet{ferguson1922robinie,chapman1935robinie}.}
...
deutlich höher als die 16 mit ihr verglichenen Baumarten. Die
...
Düngung von 135\,kg Ammoniumnitrat/ha, zweimalige Düngung von 900\,kg/ha
...
Blätterdaches das Wachstum der darunterliegenden Gräser fördert.
...
\summary{Die Robinie kann die Bodenqualität vor allem durch Stickstofffixierung, die Förderung einer lockeren und gut durchlüfteten Bodenstruktur, tiefe Durchwurzelung sowie die Anreicherung von Humus verbessern. Die Stickstofffixierung wird jedoch reduziert oder eingestellt, wenn im Boden bereits ausreichend Stickstoff vorhanden ist. Darüber hinaus ist die Robinie in der Lage, Nährstoffe aus tieferen Bodenschichten zu erschließen und die Wasserspeicherfähigkeit des Bodens zu erhöhen, was insbesondere in trockenen Regionen die Ansiedlung weiterer Baumarten erleichtert. Ihr dichtes Wurzelsystem kann zudem Nährstoffverluste durch Auswaschung verringern.}
...
\citet{schuett2014alnusIncarna} geben auch einen aus der Literatur gesammelten Überblick über die Stickstofffixierungsraten von Grauerle mit 43--72\,kgN/ha/Jahr.
...
Nach \citet{uba1998deposition} kann es bei der nassen Gesamtstickstoffdeposition zu Einträgen bis über 20\,kg/ha und Jahr kommen.
...
\begin{table}[htbp]
  ...
  \end{tabular}}
  \bicaption{Bodenporosität, Wasser-- und Luftkapazität in \% von Waldböden unter verschiedenen Baumarten nach \citet{nemec1925waldboden}.}{Soil porosity, water and air capacity (in \%) of forest soils under different tree species according to \citet{nemec1925waldboden}.}
...
Kompakte, nasse, stauende Horizonte können von den Wurzeln nicht durchdrungen \citep{auten1933robineStandort,mueller1991robinie} und somit auch kaum gelockert werden.
...
\begin{figure}[htbp]
  ...
  Zeitraum 1970--2000 abgefragt aus globalen Karten von \citet{worldclim2017}.}{Temperature and precipitation of three provenances as well as Vienna for the period 1970--2000 extracted from global maps by \citet{worldclim2017}.}
  \label{fig:wetter}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \bicaption{Verbreitung der 385\,746 Beobachtungen von Robinie nach \citet{gbifRob}.}{Distribution of 385\,746 Robinia observations based on \citet{gbifRob}.}
...
Selbstverständlich sind solche Schätzungen mit Unsicherheiten verbunden. Dennoch dürfte die Gefahr, dass ein Standort seine Eignung im Laufe der Zeit verliert, bei Baumarten, die relativ kurze Umtriebszeiten erlauben, geringer sein als bei solchen mit langen, da sich in wenigen Jahren nur begrenzte Veränderungen am Standort vollziehen. Die meisten Baumarten sind laut Forstgesetz erst ab 60~Jahren hiebsreif. Die Robinie ist in der Verordnung für raschwüchsige Baumarten aufgenommen, wo die Obergrenze ihrer Hiebsunreife mit 10~Jahren festgelegt ist. Umtriebszeiten von 15--30~Jahren sind mit Robinie auf durchschnittlichen Standorten möglich und lassen sich bei Bedarf durchaus auch auf 100~Jahre ausdehnen.

\subsection{Trockenheitstoleranz und Wassernutzung} % Wassernutzungseffizienz

Eine gefragte Eigenschaft der Robinie ist ihre relativ hohe Toleranz gegenüber Trockenheit. Robinien können sich an anhaltende Trockenheit anpassen, indem sie ihre Spaltöffnungen (Stomata) schließen und sowohl die Größe einzelner Blätter als auch die gesamte Blattfläche verringern. Sie kann auch ihre paarigen Fiederblättchen nahezu vollständig nach oben klappen und damit die der Sonne zugewandte Blattfläche reduzieren \citep{schildknecht1984blattbewegung}. Solange jedoch kein Wasserstress besteht, reduziert sie ihre Transpiration nicht und gilt daher nicht als wassersparende Baumart.
...
Die oberirdische Biomasseproduktion pro Liter Wasser (Water Use Efficiency, WUE) der Robinie beträgt etwa 2,31~g/L, bezogen auf das oberirdische Holz 1,63~g/L. Unter Wasserstress bleibt dieser Wert weitgehend stabil. Damit zählt sie nicht zu den besonders wassereffizienten Pflanzen, die mit sehr wenig Wasser viel Biomasse erzeugen können \citep{mantovani2014robinieWasser}. \citet{lindroth1994wasserverbrauchWeide} geben für Korbweide (\emph{Salix viminalis}) eine WUE von 4,1--5,5~g/L an.
...
Nach \citet{yan2009robinieVergleich} zeigte Robinie eine frühe Reaktion auf reduzierte Blattwasserpotenziale durch eine Reduktion der stomatalen Leitfähigkeit ihrer Blätter. Ihre Wassernutzungseigenschaften und die spezifische Blattfläche deuteten jedoch darauf hin, dass sie mehr Wasser verbraucht und möglicherweise nicht so trockenheitstolerant ist wie der Rundblättrige Flieder (\emph{Syringa oblata}) und die Mongolische Eiche (\emph{Quercus liaotungensis}).
...
\textit{Picea excelsa}, jung, sehr blass     & 45°        & 3.21 & 3.73 & 3.85 & 5.02 & 2.57 \\
                                             & 90°        & 3.09 & 3.41 & 3.64 & 5.19 & 2.62 \\
\textit{Picea excelsa}, adulte               & 45°        & 4.46 & 5.51 & 6.14 & 7.32 & 3.37 \\
...
\bottomrule
\end{tabular}}
    \bicaption{CO\textsubscript{2}-Mengen (in cm\textsuperscript{3}), die von 1\,g Blattmasse bei verschiedenen Temperaturen und Winkeln zur Sonne innerhalb einer Stunde aufgenommen werden \citep{lubimenko1906npp}.}{Volumes of CO\textsubscript{2} (in cm\textsuperscript{3}) absorbed by 1\,g of leaves at various temperatures and solar angles within one hour \citep{lubimenko1906npp}.}
    \label{tab:nppTempWinkel}
\end{table}

Nach \citet{lyr1963beschattung,lyr1964beschattung} wird der Zuwachs der Robinie bei Beschattung stärker als bei Weißkiefer eingeschränkt. Bei 15\,\% Freilandhelligkeit reduziert die Robinie ihr Wurzelwachstum um 85\,\%, Schwarzerle um 79\,\%, Weißkiefer um 75\,\%, Birke um 70\,\%, Douglasie um 62\,\% und Roteiche um 6\,\%.  Bei 15\,\% Freilandhelligkeit reduziert die Robinie ihr Gesamtgewicht um 79\,\%, Schwarzerle um 73\,\%, Birke um 58\,\%, Weißkiefer um 55\,\%, Douglasie um 48\,\% und Roteiche konnte sogar etwas mehr zuwachsen. Ab 70 bis 55\,\% Freilandhelligkeit tritt eine Hemmung der symbiontischen Stickstoffbindung auf.

Auch hier gibt es Unterschiede zwischen den einzelnen Klonen. Nach \citet{abri2024lightResponse,abri2024lightResponseB} ist es wahrscheinlich, dass die Klone PL251 und NK2 eine bessere Schattenverträglichkeit als die Sorte Üllöi aufweisen und auch intensivere Lichtverhältnisse besser ausnutzen.

Die Robinie zeigt sowohl in ihrer ursprünglichen Heimat als auch in Europa eine bemerkenswerte Anpassungsfähigkeit an unterschiedliche Umweltbedingungen. Ihre Fähigkeiten, Trockenheit zu tolerieren, rasch zu wachsen und CO\textsubscript{2} effizient zu verwerten, machen sie zu einer interessanten Baumart für die forstliche Nutzung, insbesondere im Hinblick auf klimatische Veränderungen. Die Unterschiede zwischen einzelnen Klonen zeigen jedoch, wie wichtig es ist, sortenspezifische Eigenschaften in waldbaulichen Planungen zu berücksichtigen.
...
\summary{Während der Eiszeiten starben in Europa wärmeliebende Arten
  ...
  Tradescant in Europa erstmals aus Samen gezogen. Erste Hinweise auf ihr
...
\citet[S.~370]{gunther1922botanists} listet Samen aus Virginia vom
18.~März 1636, die anscheinend Parkinson von Herrn Morrice erhalten
hat, mit folgendem Eintrag: \enquote{A yellow wood called
...
der Bezirksforstinspektion Gänserndorf und Mistelbach derzeit bei
...
mit der Zerreiche. \citet{bund1899robinie,gaskil1906robinie} schreiben,
dass jedes Jahr
...
Der Durchmesser von Wurzelschnittlingen sollte zwischen 1/4 und 1 Zoll
...
treiben aus). Bis zu 50\,\% der Schnittlinge von älteren Bäumen
...
bleiben. Bäume, die im Wald gesetzt werden, sollten ein vollentwickeltes Wurzelsystem, das weder eingekürzt noch zur Vermehrung
...
Variabilität. Man versucht dem entgegenzusteuern, indem einzelne
...
geringe genetische Variabilität aufweisen.  Um genetisch vielfältiges
...
äußere Form des Baumes sowie die Platzierung und das Wachstum der
Zweige ein.
...
bekam aber auch Saatgut von amerikanischen Provenienzen (Washington,
...
wohingegen Pinnate den Dichtstand weniger gut verträgt.
...
reduziert, während sich die Holzdichte kaum unterscheidet
...
Einigkeit herrscht darüber, dass die von Long Island
beschriebenen Schiffsmastrobinien gepflanzt und vorher offensichtlich
irgendwo zur Vermehrung selektioniert wurden. Manche vermuten, dass sie
aus Virginia stammen (\citet{hicks1883robinie} vor über 100~Jahren,
...
Schiffsmast--Robinien betrieben hat.
...
1938 bis 1943 über 100~Robinienklone gesammelt, die hohes Wachstum
...
getestet. Von diesen wurden fünf ausgewählt, unter denen auch die
...
den größten Höhenzuwächsen von 26 untersuchten waren. Dabei wurden
diese 3~Klone vegetativ vermehrt, während die restlichen Herkünfte
generativ über Samen vermehrt wurden. Bei dieser Untersuchung hatte
die Herkunft aus Caryville Campbell (NR.~716, 36°18'N 84°13'W), welche
auf anderen Probeflächen als die drei Klonen gepflanzt wurden,
ebenfalls deutlich höhere Höhenzuwächse gegenüber den anderen
55~Herkünften.
...
Familie Nr.~716 ebenfalls zu den stärkerwüchsigen zählt. Jedoch wird sie
dort nach zwei Jahren von 5, nach 3~Jahren von 9~Familien hinsichtlich
Biomassenzuwachs übertroffen. Nr.~716 produzierte nach 3~Jahren 10,5~t
...
überdurchschnittlichen Durchmesser sowohl in der Jugend als auch im Alter \citep{steinergroup1987robinie}.
...
50--80\,\%, aufgrund ihrer hohen Wuchsleistung, empfohlen wird. Diese
...
In \citet{liesebach2021robinie} wird zwischen Appalachia--4138 und
Appalachia--4191 unterschieden. Nach \citet{steinergroup1987robinie}
...
gibt es demnach HC-4138 bzw.\ HC-41-38 und BN-4191 welche den identen
...
auch eine vom Morris Arboretum mit 50-308. Bei manchen Nummern lassen
die ersten beiden Ziffern vermutlich auf das Jahr schließen.

\subsubsection{Moderne Züchtung in Ungarn}

Geradewüchsige Robinien sind schon lange bekannt und es gab einen
...
erhöhtem Nektarertrag \citep{kopecky1965robinienzuechtung,redei2007robinieSelektion,csiha2016robinie}.

1958 entdeckte Antal Kisrómai an mehreren Orten des Landes
Akazienvorkommen, deren Stamm- und Kronenform der Amerikanischen
Mastakazie sehr ähnlich waren. Auf Anraten von Keresztesi und der
Versuchsstation vermehrte er aus diesem Material eine beträchtliche
Menge Pflanzgut durch Wurzelschnittlinge und Veredelung. Keresztesi
beobachtete, dass die von Kisrómai entdeckte, geradstämmige
Akazienform in zahlreichen Akazienbeständen des Landes vorkam, und
begann daraufhin, deren Selektion und Vermehrung systematisch
auszuweiten \citep{kopecky1965robinienzuechtung}.

Um die Zuchtziele zu erreichen, wurden Bäume mit guter Stammform mit
solchen mit gutem Wachstum gekreuzt. Zur Reduzierung der Dornenlänge
wurde die Varietät \enquote{inermis} eingekreuzt
\citep{kopecky1965robinienzuechtung}.
...
und Üllöi hervorstechen. Zusätzlich werden in einer Grafik
...
Tab.~\ref{tab:robinienherkuenfte2} wiedergegeben sind. Dabei sind Appalachia
...
\emph{Appalachia}) in Holland für den Handel freigegeben
...
\begin{description}
  ...
  \item[Üllöi:] 1982 in Ungarn registriert, aus Üllő, Forstabteilung 10D von J.~Fila, 3--Klone, gerader Stamm, 44\,\% mehr Holzmasse der besten Qualität, Dornenlänge 10\,mm, geringe Samenproduktion, \citep{bach1983robinie,kapusi1995robinie,redei2020ulloi,abri2024dis}
...
Jászkiséri, Pénzesdombi, \emph{Röjtökmuzsaji}, \emph{Góri} und
Appalachia gut eignen, wobei Kiskunsági auch viel Honig
...
werden. In einem weiteren Schritt wurden aus den Sämlingen der 125 Stammexemplare
...
\begin{description}
  \item[Turbo:] Sämling, Schnellwüchsig \citep{nemeth2022robinie}
  \item[Turbo Obelisk:] 3--Klone (OBE26, 34, 53), 5--Klone (OBE26, 34, 53, 54, 69), Schnellwüchsig, geradschaftig \citep{nemeth2022robinie}
\end{description}
...
das Standortspektrum zu erweitern wurde in
...
\begin{description}
  ...
  \item[Bácska:] KH~56A~2/5, aus Kéleshalom, neigt zu Zwieselbildung, starkwüchsig, Dornenlänge 6--12\,mm
\end{description}
...
gekoppelt mit schnellem Jugendwachstum und hoher Stammqualität
...
\begin{description}
  ...
  \item[NK1 -- Laposi:] annähernd gerader Stamm, mittleres Höhen-- und starkes Dickenwachstum, kleine Dornen
  \item[NK2 -- Napkori:] gerader zylindrischer Stamm, starkwüchsig,
feinastig, kleine Dornen
\end{description}
Diese Sorten waren hinsichtlich Durchmesser-- und Höhenzuwachs Üllöi in der
Jugend überlegen.
...
Roy). Auch die Sorten Bendida und Tangra der Firma Lignum aus
...
Fraport3, Appalachia, Nyirségi, Bendida, Romy und hinsichtlich
geradschaftigkeit Fraport3, Jászkiséri, Appalachia, Bendida, Nyirségi
die besten.

Hinsichtlich Höhenzuwachs in 6~Jahren waren Fraport3 (7,54\,m), Roger
(6,93\,m), Rowena (6,84\,m) und Appalachia (6,76\,m) die
zuwachsstärksten. Im Trockenjahr 2018 hatten Appalachia (0,86\,m), Roy
...
wurden dabei nicht untersucht. Auch in Deutschland wurde die Robinie
...
2001 wurde von Werner Ruhm in Glaswein eine Versuchsfläche mit
Robinien angelegt, teilweise um übrig gebliebene Pflanzen aus der
Baumschule vor der Vernichtung zu retten.
...
welche anfänglich den anderen Sorten in der Wuchsleistung unterlegen
war, diese jedoch bis zum Alter von 25~Jahren nahezu wieder einholte.

2008 wurde in Laa an der Thaya eine Fläche mit der Sorte Tulln
angelegt. 2011 folgten in Groß Harras eine Fläche mit den Sorten
Tulln, Nyirségi und Zainet sowie eine weitere Fläche mit der Sorte
Üllöi. Die Anlagen erfolgten durch die Landwirtschaftskammer
Niederösterreich im Zuge des Projektes \enquote{Bewirtschaftung von
Energieholzplantagen} \citep{huber2018kurzumtrieb}.
...
Beispielsweise den Saatgutbestand Rob1~(8.1/ko) am Weichselberg bei
...
Tulln~81/29, Tulln~81/62 sowie drei Robinien aus Mariabrunn, konnten
...
und einen Brusthöhendurchmesser von 25--30\,cm. Ein 80~jähriger Bestand hatte eine
Oberhöhe von 31\,m und einen mittleren Brusthöhendurchmesser von 43\,cm.
...
Früh-- und Spätfröste oder Trockenheit können den Wipfel zum Absterben
...
sofern ausreichend Ressourcen vorhanden sind, sie zusätzlich mit
anderen Baumarten zu vergleichen, wie es beispielsweise
...
\begin{itemize}
  ...
  \item Für Agroforestry optimierte Eigenschaften wie Lichtabsorption, Wasserverbrauch oder Stickstofffixierungsrate.
\end{itemize}

\section{Vergleichspflanzung}

\summary{Verschiedene Robiniensorten werden hinsichtlich ihrer
  Wuchsleistung, Qualität und Eignung an unterschiedlichen Standorten
  miteinander verglichen. Dabei werden neuere Sorten bereits
  verfügbaren Sorten gegenübergestellt. Die Hauptversuchsfläche
  befindet sich im Weinviertel und wird ergänzt durch je eine
  Pflanzreihe in Wien und am Fuß des Schneebergs.
...
Schwarzkiefer verjüngt sich kaum natürlich, hat aber beim Pflanzen ein
...
In den Nachbarbeständen sind einige größere Robinien zu finden, jedoch zeigen
...
das dauerhafteste Holz, das sich auch ohne Holzschutzmittel für die
Verwendung im Freien eignet. In Bezug auf die natürliche
...
\citep{sari2005robinienholz,benthien2020robinieTropenholz}.
...
\citet{redei2006robiniePappel} beschreiben Mischungen von Robinie mit
...
profitiert und die Robinie zu dem Zeitpunkt, an dem die Eiche die Höhe
...
\citet[S.~174ff]{pfeil1829deutscheWaldbaeume}, der
...
lediglich auf die Beschreibung der Robinie und der Strobe (\emph{Pinus
...
Ich erwarte, dass die Robinie förderlich für Eiche und Nuss sein wird,
den Standort auch bei weitem Pflanzverband rasch ausnutzt, einen
Vorbestand bilden kann, früh hiebsreif ist und schließlich qualitativ
hochwertiges Holz liefert.
...
Robinien Nord 1/3, 1/7 und 1/11 Bodenebener Rückschnitt beim Pflanzen
...
\citet{bier1958robinie} empfiehlt die Schnittstelle 1--2\,mm stark zu
...
Überlebenschancen. Ein bodenebener Rückschnitt im Folgejahr zeigte den
größten Höhenzuwachs, konnte aber die Gesamthöhe der nicht
...
\citet[S.~51]{fekete1931robinieErtragstafel} empfiehlt 2--4~jährige
...
erleichterte mir den Transport und kann positiv beim Anwachsen sein,
...
jene, die wenig zurückgeschnitten wurden. Von den in Bodenhöhe
zurückgeschnittenen ist jedoch nur die Hälfte ausgetrieben, während
bei den auf ca.\ 80\,cm zurückgeschnittenen fast alle überlebt haben.

Nur bei Appalachia gab es mehr Ausfälle. Sie war beim Pflanzen kleiner
...
Die Bäume für diesen qualitätsfördernden Rückschnitt sollten nicht zu
...
Ein Wurzelrückschnitt beim Pflanzen wurde von mir nicht vorgenommen.
...
Die Negativauslese muss sich nicht auf die Stockausschläge
beschränken, sondern kann alle \emph{vorwüchsigen}, schlecht geformten
Bäume einschließen.
...
Durchmesser, hier also dünne hohe Bäume) durch die Windbewegung und
...
Bodenvegetation durchlassen.  Bei Robinien mit niedrigem HD-Wert sind
...
Pflanzabstände können auch an technische Gegebenheiten gebunden sein.
So wurden bei Aufforstungen in Ungarn früher Reihenabstände von
1,2\,m, später von 2,5\,m verwendet. Diese Umstellung entstand da
...
Volumszuwachs je Fläche gibt es eine, sich mit dem Alter verändernde,
optimale Bestandesdichte, die je Standort, Baumart und Sorte
verschieden sein wird.

Für freigestellte Wertträger wird, solange die natürliche
...
\begin{table*}[htbp]
  ...
  \begin{tabular}{clScSccccc}
    ...
    \hline
    2023/24 & Appalachia & 0,76 & 13 & 0,859 & 25 & 25 & Ja & USA & Österreich\\
...
Appalachia hatte die Größe 30/50\,cm und war daher günstiger als
...
25~Stk.\ angeboten. Angesichts der Tatsache, dass man im selben
...
tief wie im Pflanzgarten zu setzen. Auf Sand oder bei windigen
...
(Abb.~\ref{fig:robinieEinJahr}). Im ersten Jahr in der Kämpe gab es
keine Ausfälle.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=.8\linewidth]{./bild/robinieEinJahr}
  ...
  Robinien eine Höhe von ca.\ 1,0--1,2\,m, einzelne sogar 1,5\,m erreicht.}{Robinia after one year on a forest acclimatization nursery.\\
...
Der Pflanzentransport erfolgte mittels Bahn, Bus und Fahrrad
