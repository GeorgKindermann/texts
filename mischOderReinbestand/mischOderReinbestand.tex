\documentclass[twocolumn, paper=a4, fontsize=10pt, bibliography=totoc, index=totoc]{scrartcl}
...
%\usepackage{breqn}    
\usepackage{siunitx}
\sisetup{locale = DE, per-mode = repeated-symbol, mode = match} % mode = text
\DeclareSIUnit\festmeter{fm}
...
\makeindex[options=-L german-duden -C utf8]
\renewcaptionname{ngerman}{\indexname}{Stichwortverzeichnis}

%\usepackage[backend=bibtex, style=authoryear, natbib=true, maxcitenames=2, uniquename=false, uniquelist=false]{biblatex}
%\bibliography{literature}
\usepackage[backend=biber, style=authoryear, maxcitenames=2, natbib=true, uniquename=false, uniquelist=false, mincrossrefs=99, loadfiles=true]{biblatex}
...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    \begin{abstract}
      ...
      natürlich eine Verjüngung aus mehreren Baumarten einstellt, soll diese
      zwar in Richtung der gewünschten Bestockung geführt, dabei aber nicht mit
      übertriebenem Eifer alle anderen Baumarten ausgemerzt werden. Wenn
      künstlich gemischt verjüngt wird, müssen die beteiligten Baumarten in der
      Mischung bestimmte Aufgaben erfüllen. Andernfalls sollte auf der
      Schlagfläche die Kunstverjüngung nur mit einer Baumart durchgeführt werden
      und die Baumartenmischung auf regionaler Ebene durch ein Mosaik von
      Reinbeständen unterschiedlicher Baumarten gefunden werden. Bei Kleinstwaldbesitzern ist diese räumliche Trennung nicht immer möglich.
    \end{abstract}
  \end{@twocolumnfalse}
]
...
Argumenten untermauerte Empfehlungen zusammengetragen. Zusätzlich soll die
...
um ein Kontinuum, das von Monokulturen\index{Monokultur} mit ausschließlich einer vertretenen
...
\begin{description}
\item[Mischbestand:]\index{Mischbestand!Definition}  Ein Bestand aus zwei oder
  mehr Baumarten, die jede einzeln und besonders im Zusammenwirken die
  Bestandesökologie signifikant beeinflussen. Die Baumarten können stamm-,
...
\item[Reinbestand:]\index{Reinbestand!Definition} Bestand, der aus einer
  Baumart (mindestens \qty{90}{\percent}) gebildet wird. Vorkommen anderer eingemischter
...
eine Beimischung von bis zu \qty{10}{\percent} von anderen Baumarten toleriert. Und dabei
stellt sich bereits die Frage, worauf sich diese \qty{10}{\percent} beziehen. Meist wird
...
der Forsteinrichtung wird dieser gutachtlich, etwa über den Schirmflächenanteil\index{Schirmflächenanteil},
geschätzt. Gelegentlich wird auch der Anteil am Volumen, an der Biomasse oder,
da dies oft einfacher zu bestimmen ist, der Grundflächenanteil\index{Grundflächenanteil} verwendet. Dabei
...
Baumarten, wobei keine einen Anteil von \qty{90}{\percent} erreichen oder überschreiten
...
Baumartenwechsel über Naturverjüngung geplant ist.

Bei Naturverjüngung ergeben
sich die Baumarten und deren Anteile zu Beginn von selbst und werden im Zuge der
Mischwuchsregulierung\index{Mischwuchsregulierung} zum Bestockungsziel geführt. Aber auch bei Naturverjüngung
kann es oft nötig sein, unbestockte Flächen mittels Ausbessern zu ergänzen und
damit die Baumartenzusammensetzung schon in der Verjüngungsphase zu
beeinflussen.

Bei Kunstverjüngung muss die Anzahl an Baumarten vorgegeben
...
\citet[S.~218\,f.]{wiedemann1951Ertragskunde} fordert für Mischkulturen \enquote{eine klare Planung, welche \emph{Aufgaben} jede Baumart zu erfüllen hat, und
...
Bei Buntmischungen\index{Buntmischung} von 5 oder noch mehr Baumarten können die besonderen
...
Stammzahl zur Astreinigung unter sich selbst haben.}

Hier sei ausdrücklich darauf hingewiesen, dass sich diese Empfehlung von zwei bis
...
Eine Ausnahme bezüglich beteiligter Baumarten bilden Site--Index--Benchmark-Beispielsbestände\index{Site-Index-Benchmark-Beispielsbestände}, auf denen möglichst viele Baumarten als Subreinbestand bzw.\
...
verschiedener Baumarten am selben Standort verglichen werden, wie dies von
\citet[S.~300]{reaumur1721ertragstafel} schon vor über 300~Jahren gefordert wurde und
wie es beispielsweise \citet{mayer1970anbauversuch} zeigten. Die Baumarten können auf
solchen Flächen direkt vor Ort ohne viel Aufwand, alleine durch Betrachten,
verglichen werden. Charakteristisch für diese Bestände ist, dass viele
...
(\qty{47.4999}{\degree}\,Nord, \qty{15.9741}{\degree}\,Ost) auf \qty{1340}{\metre} 31~Baumarten, und
...
weitere Informationen nur eine geringe Aussagekraft über den Mischcharakter hat.
...
es für die Frage \enquote{Misch- oder Reinbestand?} nicht wesentlich
...
von \enquote{nicht vertreten} bis zu \enquote{mit gleichen Anteilen
vertreten}, kann der Übergang vom Rein- zum Mischbestand beobachtet
...
\begin{description}
\item[Einzel:]\index{Mischungsform!Einzel} Buntmischung. Baumweise Verteilung. Baum ist nicht von gleicher Art umgeben.
\item[Trupp:]\index{Mischungsform!Trupp} Einige, weniger als etwa 5~Bäume im Baumholzalter. Durchmesser maximal halbe Baumlänge des Altbestandes.
\item[Gruppe:]\index{Mischungsform!Gruppe} Durchmesser maximal Baumlänge des Altbestandes.
\item[Horst:]\index{Mischungsform!Horst} Kleinfläche mit teilweise ökologischer und wirtschaftlicher Selbständigkeit, die aber waldbaulich nicht selbständig behandelt werden kann. Etwa \qtyrange{0.1}{0.5}{\hectare}.
\item[Fläche:]\index{Mischungsform!Fläche} Fläche, die waldbaulich selbständig behandelt wird.
\item[Reihe:]\index{Mischungsform!Reihe} Wechsel der Baumart von Reihe zu Reihe.
\item[Streifen:]\index{Mischungsform!Streifen} Mehrere Reihen derselben Baumart.
\end{description}
...
horstweise Mischung sowohl durch Natur- als auch durch Kunstverjüngung
entstehen. Auf Kahlflächen kann auch die \emph{Clusterpflanzung}\index{Clusterpflanzung} in Form von
\emph{Nesterpflanzung}\index{Nesterpflanzung} (auf ca.\ \qty{1}{\square\metre} werden etwa 20~Bäume gepflanzt) oder
\emph{Trupppflanzung}\index{Trupppflanzung} (je Trupp werden ca.\ 20~Bäume mit einem Abstand von ca.\
\qty{1}{\metre} zueinander, gelegentlich auch mit 2~Baumarten, gepflanzt) erfolgen, wobei
...
\item Geeignete Schattbaumarten für Einzelmischung von der
  ...
  Buche.
\item Bei einer Mischung von Schatt- und Lichtbaumarten muss die
...
\item Wenn die Funktion am besten bei Einzelmischung erfüllt wird
  (Vorwald, Schaftreinigung), wobei dann eine Baumart eine dienende
  Funktion übernimmt.
\item Bei Zeitmischungen\index{Zeitmischung}: Eine Baumart wird früher als die andere
  ...
  verbleiben sollen.
\end{itemize}
\enquote{Die Einzelmischung in gleichaltrigen Bestand stellt Ansprüche an
...
Entwickelungsraum im gleichförmigen Schlusse unserer Bestände \emph{nicht erfüllen können}}
...
findet man auf Seite 78\,f., wo für Eiche mindestens $1/2$\,\unit{\hectare} gefordert
wird. Anscheinend wurden viele dieser wichtigen Hinweise zu wenig
beachtet, denn schon sein Nachfolger berichtet: \enquote{Gayers Methode
...
schlägt daher als bessere Alternative den \emph{Kleinbestandswald}\index{Kleinbestandswald} mit
Größen von \qtyrange{0.3}{3}{\hectare} vor. Jeder Kleinbestand kann von einer
...
vermeidet aber dadurch, dass er die Bezeichnung kleine Reinbestände anstatt horstweiser Mischbestände verwendet, dass fatalerweise als
Mischbestand ein in der Verjüngung stammweise gemischter Bestand
gemeint wird. Einen anderen Weg beschreibt
\citet{wagner1923DerBlendersaumschlagUndSeinSystem} mit dem
\emph{Blendersaumschlag}\index{Blendersaumschlag}, wo durch Aneinanderreihung langgestreckter,
also saumweiser Schläge, die nutzungstechnische Vorteile bringen,
streifenweise eine Baumartenmischung, wenn möglich über
Naturverjüngung, verwirklicht werden kann.

Baumarten können in bestandesbildende\index{Baumart!bestandesbildend} und nicht bestandesbildende\index{Baumart!nicht bestandesbildend}
...
Baumarten sind gegenüber bestandesbildenden konkurrenzschwach und
...
Bestandesentwicklung günstige Zufälle vereinzelt im Bestand vertreten
...
Lastverteilung im Stamm gleichmäßiger ist und deshalb kaum eine Bildung von,
üblicherweise qualitätsminderndem Reaktionsholz\index{Reaktionsholz} (Druckholz\index{Reaktionsholz!Druckholz} oder Buchs\index{Reaktionsholz!Buchs} bei
Nadelhölzern, Zugholz\index{Reaktionsholz!Zugholz} bei Laubhölzern) erfolgt. Gruppen entstehen meist aufgrund
...
\begin{description}
\item[Vertikale Struktur]\index{Bestandestruktur!vertikal} (Abb.~\ref{fig:vertikaleStruktur})
  \begin{description}
  \item[Einschichtig:] Kronenraum des Bestandes besteht aus einer Schicht.
  \item[Mehrschichtig:] Kronenraum des Bestandes besteht aus mehreren \emph{übereinanderliegenden} Höhenschichten.
  \item[Stufig:] Kronenraum des Bestandes besteht aus mehreren \emph{nebeneinanderliegenden} Höhenstufen.
  \end{description}
\item[Horizontale Struktur]\index{Bestandestruktur!horizontal} (Abb.~\ref{fig:horizontalestruktur})
  \begin{description}
  ...
  \item[Geklumpt:] Auch Rottenstruktur\index{Rottenstruktur}. Bäume stehen gedrängt in Gruppen.
  \end{description}
\end{description}
...
\begin{figure}[htbp]
  ...
  \label{fig:horizontalestruktur}
\end{figure}

Zu einer Mischung in zwei Bestandesschichten kommt es oft bei
Vergesellschaftung einer Haupt- und einer dienenden Baumart\index{dienende Baumart}, also
...
Die Anteile der Baumarten an der Bestandesfläche sind entsprechend der Menge der
...
eines Referenzwertes mit einfließen. Der Referenzwert\index{Referenzwert!Flächenbedarf} gibt an, wie groß die
...
kann über die Relation \enquote{Summe der Referenzflächen zur Bestandesfläche}
abgeleitet werden, ob die Produktivität höher oder niedriger als im homogenen
Reinbestand ist.

An dieser Stelle stellt sich die berechtigte Frage, ob nicht die
...
erfolgen müssen. Die Bewertung kann erst anschließend durchgeführt werden. Dazu
bedarf es neben dem Referenzwert des Flächenbedarfs zusätzlich auch eines des
Wert-, Schaftholz-, Derbholzzuwachses\index{Referenzwert!Wert- und Holzzuwachs} oder einer anderen Zielgröße, mit der
...
gebietsfremde Baumarten beziehend: \enquote{Trotz der 50jährigen
...
\qty{20}{\percent} der Revierfläche. Gewisse, oft sogar sehr große Einbußen
durch Insekten und andere Waldkrankheiten nehmen wir ja auch bei
unseren einheimischen Holzarten als selbstverständlich hin.}
Zwar ohne konkrete Zahlen und auf die Fichte konzentriert beschreibt
\citet[S.~394]{assmann1961Waldertraskunde} die Problematik: \enquote{Weit
...
Reinanbau der Fichte zurückhalten.} Dass der großräumige
\emph{Totalausfall}\index{Totalausfall} einer Baumart durchaus nichts Ungewöhnliches ist,
...
zwischen Misch- und Reinbestand aufgezählt. Dabei ist zu beachten, dass es kaum Vorteile
...
längerer Zeit in Lehrbüchern z.\,B.\ \citet{wiedemann1951Ertragskunde},
\citet{assmann1961Waldertraskunde} oder \citet{mitscherlich1978WaldWachstumUmwelt}
sowie in Fachartikeln z.\,B.\ \citet{baader1942WasLeistetDerMischbestand},
\citet{kennel1965MischbestandFichteBuche},
\citet{mitscherlich196566ReinUndMischbestand}, \citet{guericke2001mischungBuLae},
\citet{pretzsch2003mischwald}, \citet{bauhus2004mischung} oder
\citet{kelty2006mischwald} publiziert.

Auf Standorten mit günstiger Ressourcenverfügbarkeit kann meist die
Produktivität von Beständen mit Lichtbaumarten durch das Einbringen
von Schattbaumarten im Unterbestand gesteigert werden. Auf wasser-
oder nährstofflimitierten Standorten kann die zusätzliche
Mischungskomponente hingegen zu einer stärkeren Konkurrenz um Wasser
und Nährstoffe führen, wodurch sich der Trockenstress oder
Nährstoffmangel im Oberbestand erhöhen und den Zuwachs verringern
kann. Die Produktivität von Beständen mit Schattbaumarten kann
...
etwa Robinie, Erle, Geweihbaum, Gleditschie, Gelbholz, Schnurbaum,
Goldregen, Sanddorn, Ölweide, Blasenstrauch, Ginster oder anderen, zum
...
wie dies bei Tanne, Lärche, Traubeneiche oder Schwarzerle von
\citet[S.~114, 130, 150, 180]{koestler1969WurzelnDerWaldbaeume}
...
etwa \citet{jentsch1911fruchtwechsel} die Frage auf, ob ein Fruchtwechsel\index{Fruchtwechsel} auch in
der Forstwirtschaft Sinn mache, was von \citet{sieber1919Holzartenwechsel} und
\citet{fabricius1924Holzartenwechsel} nochmals aufgegriffen, aber nie eindeutig
beantwortet wurde. Allerdings beobachtete \citet{simak1951Baumartenwechsel},
dass es in natürlichen Plenterwäldern durchaus zu einem gegenseitigen Wechsel
des Standortes zwischen Baumarten kommt.

\citet{pretzsch2017mischwald} beobachteten, dass in einigen
Mischbeständen, zusammengesetzt aus zwei Baumarten, deren laufender Zuwachs größer war als die Summe zweier proportional gleich großer Reinbestände dieser beiden Baumarten. Diese Aussage bedeutet aber
keinesfalls, dass der Mischbestand je Fläche und Zeit mehr produziert
als der Reinbestand der \emph{produktiveren} der beiden verglichenen
Mischbaumarten.\\
Z.\,B.\ sei der laufende Zuwachs:\\
\begin{tabular}{lr@{\,}l}
    Fichte:                      & \qty{10.0}{\festmeter\per\hectare\per\jahr}\\
    Buche:                       &  \qty{8.0}{\festmeter\per\hectare\per\jahr}\\
    \qty{50}{\percent} Fichte + \qty{50}{\percent} Buche: &  \qty{9.3}{\festmeter\per\hectare\per\jahr}\\
\end{tabular}\\[0.5em]
In dem fiktiven Beispiel produziert der Mischbestand aus Fichte und
Buche mehr als die erwarteten \qty{9.0}{\festmeter}, aber weniger als Fichte
rein. Ähnliches gilt auch für die Biomasseproduktion.
\citet{sterba2018struktur} führen den Effekt der Mehrleistung
...
auch Beobachtungen, dass der Mischbestand weniger leistet als zwei
gleich große Reinbestände.

\citet{vospernik2021grundflaechenzuwachs} konnte positive als auch
...
beobachtet. Nach \citet{kindermann2018siteIndex} zeigte Fichte bei
Beimischung von Schwarzerle eine Steigerung der Oberhöhenbonität, bei
Beimischung von Esche und Lärche eine geringe, bei Birke und Tanne eine
...
\end{itemize}
hervorgerufen werden kann. \citet{vanclay2022competitioninMixedSpecies}
...
richtete. Dies wird im Waldbau gelegentlich als treibende Baumart\index{treibende Baumart} beschrieben.
Teilweise kann dieser Effekt auch durch die Bestandesdichte bedingt sein.
\citet{boehmerle1903BestandesdichteUndBestandeshoehe},
\citet{schmied1928UeberDenEinflussDerBestandesdichteAufDieBestandeshoeheInJuengerenBuchenbestaenden},
...
\citet{zundel1960ErtragskundlicheUntersuchungenInZweialtrigenBestaendenNordwuerttembergs}
...
Hainbuche) begründet. Umgekehrt gibt es aber auch Beobachtungen, dass
die Qualität durch die Mischung leidet. So beschreibt
\citet{burger1925plenterwald}, dass Laubbäume im Mischbestand
schlechtere Schaftformen haben als im Reinbestand. Nach
\citet{tiebel2016qualitaet} ist bei der Mischung von Fichte und Buche
die Astreinigung und die Ausbildung gerader Schäfte im Horst
begünstigt, nicht jedoch in der Kontaktzone zwischen den
Arten. \citet{rais2019MischungQualitaet} beschreibt, dass besonders die
...
Steifigkeiten. Nach \citet{pretzsch2016holzqualitaetMischRein} halten
sich die Beobachtungen von Festigkeitszu- und -abnahme zwischen
...
Wesentliche stabilitätsbeeinflussende Faktoren sind die
Bestandesbehandlung (Durchforstungsstärke und -häufigkeit), die
Umtriebszeit, der Standort und dessen Einfluss auf die Wuchsleistung
(z.,B.\ der Einfluss der Baumhöhe auf das Windwurfrisiko), die
Durchwurzelungsintensität (z.,B.\ häufig geringere Durchwurzelung auf
Pseudogley), die Exponiertheit (Windstärke, Nassschneelage) sowie die
Gefährdung durch Trockenheit, Überflutung, Frost und Hitze.
Diese Faktoren kommen bei verschiedenen
Baumarten unterschiedlich zur Ausprägung. Leider leisten stabile Baumarten nicht
...
\citet{molisch1937allelopathie} zeigte, dass sich Pflanzen nicht nur gegenseitig
...
\emph{Allelopathie}\index{Allelopathie} bezeichnet wird. Beispielsweise verhindert die Walnuss mit
...
denen die Mischungseignungen von einigen Pflanzen dargestellt sind. Solche
...
\citet{schmidtVogt1987Sturmstabilitaet} zeigt, dass
Fichten--Tannen--Mischbestände gegenüber \emph{Windwurf stabiler} sind
als reine Fichtenbestände. \citet{schuetz2006stabilitaetMischbestand}
...
zeigten \citet{schume2004wasserFichteBuche}, dass die Beimischung von
Buche zur Fichte den \emph{Wasserstress}\index{Wasserstress} der Fichte
\emph{steigert}. Nach \citet{nothdurft2020mischbestand} wurde die
...
Reinbeständen, verringert. \citet{thurm2016mischungDougBuStress}
...
Reinbestand. \citet{neuner2015FichteAusfall} beobachteten, dass Fichte
im Mischbestand eine höhere Überlebenschance
hatte. \citet{schnabel2022mischwaldTrockenstress} zeigen, dass eine
Mischung nicht automatisch zu einer Reduktion des Wasserstresses führt.
\citet{streel2022Mischbestand} zeigen, dass die Mischung von Buche und Kiefer
gegenüber deren Reinbeständen keinen signifikanten Effekt auf die
Trockenheitsresistenz hat.

\citet{sylvie2021mischwaldInsekten} zeigten, dass eine
...
Eine in der Natur zu beobachtende Lösung besteht darin, mehreren Baumarten
in der Verjüngung durch kleinflächige Mischungsformen oder Einzelmischung eine Chance
zu geben, sodass sich im Laufe der Bestandesentwicklung die konkurrenzstärkste 
Baumart durchsetzt.
Bei einer künstlichen Bestandesbegründung ergibt sich das Problem,
dass die Verjüngung, wenn man ja damit rechnet, dass eine Baumart ausfällt, so
dicht sein sollte, wie sie ohne weitere Baumart wäre, was Kosten verursacht.
...
oder dass ein Reinbestand dieser konkurrenzstarken Baumart nicht das
Bestandesziel darstellt und mit (kostspieligen) Eingriffen das Überleben der
anderen Baumarten erst ermöglicht wird.

Dadurch, dass der Zeitpunkt, wann eine Baumart ausfällt, im Vorhinein nicht
bekannt ist, ist die Planung dieser Zeitmischung nicht möglich. Gelegentlich
hört man das Argument, dass der beim Ausfallen einer Baumart \emph{frei
...
sehr geringen Anteilen dieser potentiell ausfallenden Baumart realisiert
...
verbleibenden Bestand führen. Die dabei entstehenden Lücken können das Risiko
des verbleibenden Bestandes z.\,B.\ hinsichtlich Windwurf oder Sonnenbrand
erhöhen. Eine durch die Lücke erhöhte Wasserreiserbildung\index{Wasserreiserbildung} kann die Qualität
mindern. Bei größeren Lücken kann eine erwünschte Verjüngung z.\,B.\ durch
vermehrte Schneeablagerung erschwert werden oder nötige Verbissschutzmaßnahmen
...
ausgewählt wurden, ist die Frage, ob diese besser in Reinbeständen oder
in Mischbeständen stocken sollen, und wie groß deren Anteile sein sollen,
individuell zu beantworten. Dabei spielen neben den ausgewählten Baumarten der
Standort, die Größe und Qualität der bereitstellbaren Arbeitsleistung vonseiten
des Besitzers sowie dessen voraussichtlichen Nachbesitzern, aber auch die
...
\citet{heinrichs2019Reinbestand} oder \citet{schall2017Reinbestand} zu dem
Ergebnis kommen, dass gleichaltrige Reinbestände verschiedener Baumarten auf
regionaler Ebene oft eine höhere Biodiversität aufweisen als ungleichaltrige
...
Region zu erzielen. Dabei ist zu erwarten, dass der Charakter beispielsweise
zwischen Fichten- und Buchenreinbeständen deutlicher variiert als innerhalb
von Fichten--Buchen--Mischbeständen. Am meisten Variation ist wohl zu
erwarten, wenn sowohl Fichten- und Buchenreinbestände als auch
...
\citet{zhang2022MischwaldDeposition} zeigen in
ihrer Beobachtung, dass die Deposition\index{Deposition} mit der Baumartendiversität
...
\citet{knoke2007mischwald} betont, dass bei der Bewirtschaftung
...
Schnellwuchsbetrieb\index{Schnellwuchsbetrieb}
...
gegenläufig entwickeln und deren Risiken sich nicht überschneiden. Bei
einer großflächigen Mischung, d.\,h.\ kleine Reinbestände aus Fichte
und Buche, soll das Risiko eines Verlustes von \qty{30}{\percent} im Fichtenbetrieb
auf \qty{22}{\percent} im Fichten--Buchen--Betrieb absinken. Gleichzeitig sinken
...
erzielbaren Ertrages erkauft. \citet{knoke2007mischwaldB} erwartet sich
eine ökonomische Überlegenheit von der kleinflächigen Mischung
(\qtyproduct{25 x 40}{\metre}) von Fichten und Buchen gegenüber großflächigen
Mischungen, was wohl auf die hier vom Mischungsanteil der Baumarten
unabhängige Annahme, dass bei der kleinflächigen nur \qty{20}{\percent}, bei der
großflächigen hingegen \qty{40}{\percent} der Fichten ausfällen werden,
...
Folgebeständen zu finden sein. Dennoch sollten diese Erfahrungen nach Möglichkeit
...
scheint es sogar angebracht zu sein, der natürlichen Entmischung
...
bestimmte \emph{Aufgaben} erfüllen. Z.\,B.\ übernimmt im Eichen-Hainbuchenwald hauptsächlich die Eiche die Wertleistung und die
...
Baumarten tatsächlich erfüllt werden können, sollte in der Praxis öfter
beobachtet worden und idealerweise durch Messungen quantifizierbar
sein. Eine Abwägung der Vorteile mit den Nachteilen, die durch die Mischung entstehen können, darf nicht unterbleiben.
...
\emph{zwei bis höchstens drei Baumarten} einen Mischbestand
...
Ausbildung bzw.\ Erfahrung sowohl des Planenden als auch des Ausführenden.
...
zu konkurrenzbedingter Entmischung\index{Entmischung} kommt. Die Schlagfläche mit jeweils
...
verjüngen und damit einen \emph{Baumartenwechsel}\index{Baumartenwechsel} zu realisieren. Je
nach beteiligter Baumart sollte damit der überwiegende Teil der
Bestandesfläche nicht weiter als \qtyrange{30}{70}{\metre} vom Bestandesrand entfernt
liegen, was bei quadratischer Form \qtyrange[parse-numbers=false]{1/3}{2}{\hectare} entspricht.
...
Erhöhung des Ausfallrisikos gerechnet werden. Daher sollte nach
...
Baumarten vertreten sein, wobei der Begriff Region nicht zu groß (\qty{500}{\hectare} Wald) gefasst und gesondert nach Höhenstufen betrachtet werden
...
selbst wenn sie annähernd gefunden wurde, aufgrund der meist aufwändigeren Behandlung nicht umgesetzt werden.
Dieser Umstand ist in vielen anderen Fällen ähnlich. Ein aufwändig
zubereitetes Mittagessen wird in der Regel besser schmecken als Spiegeleier mit
Pommes frites. Dafür muss aber ein höherer Aufwand betrieben werden, der Koch
...
Bestand zu Bestand entschieden werden. Genauso wie es keine
universelle Baumart und kein universelles Waldbausystem gibt, darf
auch keine Baumart und kein System kategorisch im Vorhinein als
...
der Außernutzungstellung bis hin zur Produktion von Furnierholz
