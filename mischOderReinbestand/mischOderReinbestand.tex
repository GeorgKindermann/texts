...
die auf diesen Standorten nicht überzeugen konnten, dokumentieren dass
es, ihnen überlegene, Baumarten gibt und somit für Wirtschaftswälder
weniger in Frage kommen. Um eine kleine Vorstellung über mögliche
Baumarten einer Region zu bekommen, wurden im Jahr~2017 am Wechsel
($47,4999^{\circ}$\,Nord, $15,9741^{\circ}$\,Ost) auf 1340\,m
31~Baumarten, und im Jahr~2019 der Klimaforschungswald in der Nähe von
Matzen mit 15~Baumarten, auf Versuchsflächen gepflanzt. Ein weiterer
Ausbau dieses Versuchsnetztes könnte die sonst üblichen Möglichkeiten,
bei der Baumartenwahl, erweitern und auf eine sicherere Grundlage
stellen.
...
ändern. Aus einer truppweise Mischung im Jungbestand kann im
Altbestand eine Einzelmischung werden.
...
Reinbestand. Damit entsteht wohl Mischungen und Bestandesmuster die
...
gleichaltrigen zum ungleichaltirgien, mehrschichtigen Bestand
...
Nutzungseffizienz der Resourchen, von den verschiedenen Baumarten,
...
Blattmasse), angibt, wie groß \emph{die Fläche} sein muss, um den
...
etwas Robinie, Erle, Geweihbaum, Gletitschie, Gelbholz, Schnurbaum,
...
wie dies von Tanne, Eiche oder Schwarzerle angenommen wird, können
damit Nährstoffe oder im Boden gespeichertes Wasser erschließen und
damit die Wuchsleistung steigern. Wobei dieser Effekt, zumindest
Teilweise, auch zu erwarten ist, wenn diese Arten den Vorbestand
bilden. So warf etwa \cite{jentsch1911fruchtwechsel} die Frage auf, ob
ein Fruchtwechsel auch in der Forstwirtschaft Sinn mache. Was von
...
aber darauf hingewiesen, dass diese Bonitätsveränderung durch die
beigemsichten Baumarten, durch die Etablierung von Mischbeständen auf,
von den berücksichtigten Standortsfaktoren nicht erfassten, weiteren
abweichenden Faktoren, gegenüber den Reinbeständen und durch, von
Reinbeständen abweichende Behandlung, der Baumarten in den
Mischbeständen, hervorgerufen werden kann.
...
Gefährdung durch Trockenheit oder Überflutung, Frost und Hitze. Diese
...
beobachteten, dass auf einem Standort mit Rotbuchen -- Douglasien
Mischung ein Trockenstress für die Douglasie, in der Mischung,
geringer war als im Reinbestand, hingegen litt die Rotbuche, in der
Mischung, stärker unter dem Trockenstress als im
...
unabhängige, Annahme, das bei der kleinflächigen nur 20\,\% bei der
...
sollte zunächst alles als Möglichkeit in Betracht genommen werden
dürfen.
