...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    \begin{abstract}
      ...
      Reinbeständen, unterschiedlicher Baumarten, gefunden werden.
    \end{abstract}
  \end{@twocolumnfalse}
]
...
\begin{description}
\item[Mischbestand:\index{Deffinition!Mischbestand}] Ein Bestand aus zwei oder
...
\item[Reinbestand:\index{Deffinition!Reinbestand}] Bestand, der aus einer
...
maximal drei Baumarten auf den Bestand und nicht auf die Region bezieht. Aber
auch auf regionaler Ebene wird es gelegentlich schwerfallen, mehrere,
...
in der Praxis besser abschneiden, da ihre Umsetzung leichter ist und seltener
schiefgehen wird.

Eine Ausnahme, bezüglich beteiligter Baumarten, bilden Site--Index--Benchmark Beispielsbestände,
